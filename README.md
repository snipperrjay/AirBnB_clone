...
The console was developed in Ubuntu 22.00LTS using Python3 (version 3.4.3).
* Repo Contents:
This repository constains of content below;

|   **File**   |   **Description**   |


|[AUTHOR](./AUTHOR) Contains information of the author of this project.
...
* Author:
Alfred Abaidoo - https://github.com/snipperrjay
